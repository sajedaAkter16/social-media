...
<div className="modal">
  <div className="modal-box relative">
    <label htmlFor="signup-modal" className="btn btn-sm btn-circle absolute right-2 top-2 ">✕</label>
              ...
              <svg className='ml-20 mt-8 h-9 w-9' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6">
