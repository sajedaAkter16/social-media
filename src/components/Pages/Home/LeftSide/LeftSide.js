...
import study from '../../../assets/download.jpg'
import travel from '../../../assets/travel.jpg'
import web from '../../../assets/download (4).jpg'
import course from '../../../assets/english.jpg'
...
const LeftSide = () => {
    return (
        <div className='bg-gray-100'>
            ...
            <div class="flex flex-col  lg:text-2xl  p-9 rounded">
